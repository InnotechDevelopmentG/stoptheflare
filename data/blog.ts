...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: 'adrenal-thyroid-connection',
    title: 'The Adrenal-Thyroid Connection: Cortisol, Stress & Hashimoto\u2019s',
    excerpt:
      'Chronic stress and cortisol can blunt thyroid function and worsen Hashimoto\u2019s. Here is how the adrenal-thyroid link works \u2014 and what actually helps.',
    category: 'Hashimoto\u2019s',
    conditionSlug: 'hashimotos',
    readTime: '8 min read',
    date: '2026-06-07',
    body: [
      ...
      'Sustained high cortisol can suppress TSH signaling from the pituitary, reduce the conversion of inactive T4 into active T3, and increase reverse T3 \u2014 an inactive form that blunts thyroid action. The net effect is that you can have \u201Cnormal\u201D thyroid labs and still feel hypothyroid, because the active hormone is not getting where it needs to go. If your labs look fine but you still feel awful, our guide on being [still tired on levothyroxine](/blog/still-tired-on-levothyroxine) explores other pieces of that puzzle.',
      ...
      '### Magnesium',
      'Magnesium is involved in the stress response and is commonly depleted by chronic stress. A well-absorbed [magnesium glycinate](go:pure-encapsulations-magnesium) is calming, supports sleep, and is one of the most useful basics for stressed people with Hashimoto\u2019s. Take it in the evening.',
      '### Vitamin D',
      'Low vitamin D is common in autoimmune thyroid disease and plays a role in immune regulation. Correcting a deficiency with a [vitamin D with K2](go:thorne-vitamin-d-k2) supports the immune side of the equation \u2014 test first where you can.',
      ...
      'Think of stress management and the basics above as the foundation that lets the rest of your Hashimoto\u2019s plan work. The thyroid-specific supports \u2014 selenium for antibodies, correcting deficiencies, appropriate medication \u2014 are covered in our [best supplements for Hashimoto\u2019s](/blog/best-supplements-for-hashimotos) roundup, and the complete picture is in our [Hashimoto\u2019s protocol](/hashimotos). If your labs are confusing, our [thyroid labs explained](/blog/thyroid-labs-explained) guide helps you interpret them, including the T4-to-T3 conversion that cortisol affects.',
      '## The bottom line',
    ...
    faqs: [
      {
        q: 'Can stress make Hashimoto\u2019s worse?',
        a: 'Yes. Chronic stress raises cortisol, which can suppress TSH signaling, reduce conversion of T4 into active T3, and increase inactive reverse T3 \u2014 so you can feel hypothyroid even with normal labs. Stressful life events are also a recognized trigger for autoimmune flares, making stress management a genuine part of Hashimoto\u2019s care rather than an optional extra.',
      },
      {
        q: 'Is adrenal fatigue real?',
        a: 'Adrenal fatigue is not a recognized medical diagnosis, and the idea that adrenals simply burn out is not supported by good evidence. What is real is HPA-axis dysregulation \u2014 the stress system becoming less rhythmic under chronic load \u2014 and the separate, serious condition of adrenal insufficiency (Addison\u2019s), which needs proper diagnosis. Get evaluated rather than self-treating with adrenal supplements.',
      },
      {
        q: 'What supplements help cortisol and thyroid balance?',
        a: 'The most useful basics are magnesium glycinate, which is calming and often depleted by stress, and correcting a vitamin D deficiency, which supports immune regulation in autoimmune thyroid disease. These work best alongside the real foundations \u2014 consistent sleep, morning light, and stress-reduction practices \u2014 rather than instead of them. Discuss additions with your clinician.',
      },
      {
        q: 'Does high cortisol lower thyroid hormone?',
        a: 'Sustained high cortisol can blunt thyroid function by suppressing TSH from the pituitary, slowing the conversion of T4 into active T3, and raising inactive reverse T3. The result is reduced thyroid action at the tissue level, which can leave you feeling hypothyroid despite lab values that appear within range.',
      },
    ],
  },
  {
    slug: 'low-fodmap-diet-guide',
    title: 'The Low-FODMAP Diet: A Practical Guide for IBS',
    excerpt:
      'The low-FODMAP diet is the most evidence-backed dietary approach for IBS. Here is how the three phases work, what to eat, and how to do it without over-restricting.',
    category: 'Gut Health',
    conditionSlug: 'gut-health',
    readTime: '9 min read',
    date: '2026-06-07',
    body: [
      ...
      'It is also worth confirming you are dealing with IBS and not something else first. Our guide on [IBS vs IBD](/blog/ibs-vs-ibd-whats-the-difference) explains the difference and why it matters \u2014 the low-FODMAP diet is for IBS-type symptoms, not a substitute for diagnosing inflammatory bowel disease.',
      '## Supportive supplements',
      'Diet does the heavy lifting, but a couple of supports can help around the edges. [Digestive enzymes](go:pure-encapsulations-digestive-enzymes) including lactase or alpha-galactosidase can ease specific reactions to dairy or legumes when you eat them. A well-studied probiotic like [Florastor (S. boulardii)](go:florastor-s-boulardii) is sometimes used alongside dietary changes; our [best supplements for leaky gut](/blog/best-supplements-for-leaky-gut) guide covers the broader options and our complete [Gut Health protocol](/gut-health) puts them in order.',
      '## The bottom line',
  ...
  },
  {
    ...
    body: [
      ...
      'There is also a barrier angle: omega-3s support healthy skin lipids and help the skin hold onto moisture, which matters in eczema where a leaky barrier is central. Our guide on [topical steroid alternatives](/blog/topical-steroid-alternatives) covers how barrier repair and anti-inflammatory support work together.',
      ...
      '### Psoriasis',
      'Omega-3s have been studied more in psoriasis, where they may reduce redness, scaling, and itch, and where they make particular sense given psoriasis\u2019s links to systemic inflammation and cardiovascular risk \u2014 omega-3s support the heart too. Again, the benefit is supportive and additive to standard care. Our [vitamin D for psoriasis](/blog/vitamin-d-for-psoriasis) guide covers another evidence-based nutrient for this condition.',
      '## How to use fish oil for skin',
      'A few practical points make the difference between a useful supplement and a waste of money.',
      '### Dose and quality',
      'Skin benefits in studies generally come from meaningful doses of combined EPA and DHA, not the tiny amounts in cheap capsules. A high-quality, properly concentrated [omega-3 fish oil](go:nordic-naturals-ultimate-omega) that lists its actual EPA and DHA content \u2014 and is third-party tested for purity and freshness \u2014 is worth the modest extra cost. Rancid fish oil is pro-inflammatory, the opposite of what you want.',
      '### Cod liver oil as an alternative',
      'For eczema and psoriasis specifically, [cod liver oil](go:nordic-cod-liver-oil) is an interesting option because it supplies omega-3s alongside naturally occurring vitamins A and D, both relevant to skin and immune function. Just be mindful that it contains vitamin A, so do not double up with other high-dose vitamin A sources.',
      '### Give it time',
      ...
      '## Where it fits',
      'Fish oil is a solid foundational support for inflammatory skin, best combined with relentless barrier-repair moisturizing, trigger management, and adequate vitamin D. Our [best supplements for eczema](/blog/best-supplements-for-eczema) roundup ranks the options, and the complete [Eczema & Skin protocol](/eczema-psoriasis) puts the whole plan together.',
      '## The bottom line',
    ...
    faqs: [
      ...
      {
        q: 'How much fish oil should I take for skin?',
        a: 'Skin benefits in studies generally come from meaningful combined EPA and DHA doses, not the small amounts in cheap capsules. Choose a concentrated, third-party-tested product that lists its actual EPA and DHA content, and follow its dosing. Quality and freshness matter \u2014 rancid fish oil is pro-inflammatory \u2014 so buy from a reputable brand.',
      },
      {
        q: 'Is cod liver oil good for psoriasis?',
        a: 'Cod liver oil is a reasonable option because it supplies omega-3s plus naturally occurring vitamins A and D, all relevant to skin and immune function in psoriasis. The main caution is its vitamin A content \u2014 avoid combining it with other high-dose vitamin A sources. Like regular fish oil, it is supportive and additive to standard care rather than a cure.',
      },
      {
        q: 'How long does fish oil take to help skin?',
        a: 'Omega-3s act slowly, so expect to take a quality fish oil consistently for about 8 to 12 weeks before judging whether it helps your eczema or psoriasis. Use it alongside your core skincare, trigger management, and any prescribed treatment rather than expecting it to work on its own.',
      },
    ],
  },
  {
    slug: 'd-ribose-for-energy',
    title: 'D-Ribose for Energy: Does It Help Fibromyalgia & Fatigue?',
    excerpt:
      'D-ribose is marketed for energy and fibromyalgia. Here is what the science actually shows, who might benefit, and how it compares to other fatigue supplements.',
    category: 'Fibromyalgia & Fatigue',
    conditionSlug: 'fibromyalgia-chronic-fatigue',
    readTime: '8 min read',
    date: '2026-06-07',
    body: [
      ...
      '## Who might benefit',
      'Based on the rationale and the populations studied, D-ribose is most worth considering if you have **fibromyalgia or chronic fatigue with a clear energy-depletion pattern** \u2014 particularly post-exertional crashes. If light activity wipes you out for days, our guide on [post-exertional malaise](/blog/post-exertional-malaise) explains that pattern and why pacing comes first. D-ribose is a possible support around the edges of good pacing, not a way to override your limits.',
      '## How it is used',
      'In the studies, D-ribose was typically taken as a powder, around 5 grams two to three times a day, dissolved in water or a drink. A [D-ribose powder](go:jarrow-d-ribose) mixes easily and is mildly sweet. It is generally well tolerated; because it is a sugar, some people notice a brief drop in blood sugar or lightheadedness if taken on an empty stomach, so taking it with food can help. People with diabetes should be cautious and involve their doctor.',
      '## How it compares to other options',
      'D-ribose is rarely a first choice \u2014 it is usually layered onto more established basics. [CoQ10](go:thorne-coq10) supports the mitochondria directly and has more study behind it; our [CoQ10 vs ubiquinol](/blog/coq10-vs-ubiquinol-for-fatigue) guide explains which form to pick. Magnesium and B-vitamins cover common deficiencies. Many people build from those foundations first and add D-ribose if they still want to target ATP recovery. Our [best supplements for fibromyalgia](/blog/best-supplements-for-fibromyalgia) roundup and the full [Fibromyalgia & Fatigue protocol](/fibromyalgia-chronic-fatigue) show the priority order.',
      '## The bottom line',
    ...
    faqs: [
      {
        q: 'Does D-ribose really help fibromyalgia?',
        a: 'Small studies in fibromyalgia and chronic fatigue reported improvements in energy, sleep, and pain for most participants taking D-ribose, which is promising. However, those studies were small and mostly lacked placebo controls, so the benefit may be overstated. D-ribose is best viewed as a reasonable, well-tolerated thing to try \u2014 not a proven treatment \u2014 layered onto solid basics and pacing.',
      },
      {
        q: 'How much D-ribose should I take for energy?',
        a: 'In the studies, D-ribose was typically taken as a powder at around 5 grams two to three times daily, dissolved in water or a drink. It is mildly sweet and mixes easily. Because it is a sugar, taking it with food can prevent the brief lightheadedness some people feel on an empty stomach, and those with diabetes should involve their doctor.',
      },
      {
        q: 'Is D-ribose or CoQ10 better for fatigue?',
      ...
      {
        q: 'Is D-ribose safe?',
        a: 'D-ribose is generally well tolerated. The main thing to know is that it is a sugar, so taken on an empty stomach it can cause a brief drop in blood sugar or lightheadedness \u2014 taking it with food helps. People with diabetes or blood-sugar concerns should be cautious and check with their doctor before using it.',
      },
    ],
  },
  {
    slug: 'dao-enzyme-supplements-compared',
    title: 'DAO Enzyme Supplements Compared: Which One Actually Works?',
    excerpt:
      'DAO supplements help break down dietary histamine \u2014 but they are not all equal. Here is how they differ, what to look for, and how to use them correctly.',
    category: 'Histamine & MCAS',
    conditionSlug: 'histamine-mcas',
    readTime: '8 min read',
    date: '2026-06-07',
    body: [
      'If you have histamine intolerance, a DAO enzyme supplement is one of the most targeted tools available \u2014 it supplies the very enzyme your gut uses to break down histamine in food. But DAO products vary more than most people realize, in source, strength, and added ingredients, and using them wrong is a common reason people conclude \u201CDAO doesn\u2019t work.\u201D Here is how to compare them and use them properly.',
      '## What DAO supplements do',
      'Diamine oxidase (DAO) is the enzyme that clears histamine from food in your small intestine. When your own DAO is low, dietary histamine builds up and triggers flushing, headaches, hives, digestive upset, and a racing heart. A DAO supplement provides extra enzyme right when you eat, helping break down the histamine in that meal before it causes trouble. Crucially, it works **locally in the gut on food histamine** \u2014 it does not lower histamine your body produces internally, which is why it helps with food reactions specifically.',
      'For the full picture of how DAO depends on nutrients like B6 and copper, see our guide on [B6, copper, and DAO](/blog/b6-copper-and-dao).',
      '## How DAO products differ',
      'When comparing supplements, a few factors actually matter.',
      '### Source of the enzyme',
      'Most DAO supplements derive the enzyme from porcine (pig) kidney, which is the form with the most research behind it. Some newer products use plant-derived or fermentation-based DAO, which suit vegetarians but have less data. If evidence is your priority, the porcine-derived options are the most studied.',
      '### Enzyme activity (the number that counts)',
      'The meaningful measure is not milligrams but **DAO activity units (often listed as HDU \u2014 histamine-degrading units)**. A product can list a big milligram number while delivering little active enzyme. Look for the activity units and compare those, not the capsule weight.',
      '### Added cofactors',
      'Some formulas add vitamin C, B6, or other supportive nutrients that the histamine pathway uses. These can be convenient, but if you already supplement those separately, watch your totals so you do not over-do B6, which has an upper limit.',
      '## What to look for',
      'Putting it together, a good DAO supplement clearly states its enzyme **activity units**, ideally uses a well-studied source, comes from a reputable brand with third-party quality control, and is free of fillers you react to (people with histamine issues are often sensitive to additives). A dedicated [DAO enzyme supplement](go:seeking-health-dao-enzyme) that lists its activity and is formulated for sensitive users is a sensible starting point.',
      '## How to use DAO correctly',
      'This is where most people go wrong. DAO must be taken **shortly before eating** \u2014 typically 15 minutes before a higher-histamine meal \u2014 so the enzyme is present when the food arrives. Taking it after you eat, or hours away from food, largely wastes it. It is meant for meals you know are higher in histamine (aged, fermented, leftover, or fermented-drink-containing), not necessarily every bite. And it is a tool for managing reactions, not a license to ignore diet \u2014 pairing it with a [low-histamine diet](/blog/low-histamine-diet-guide) to lower your overall load works far better than relying on the enzyme alone.',
      'Supporting your own DAO matters too. Ensuring adequate B6 with an [active B6 (P5P)](go:seeking-health-p5p) where you are short, and not running low on copper, helps your native enzyme function between doses.',
      '## Where it fits',
      'DAO is one piece of a histamine strategy that also includes diet, mast-cell support like quercetin, and addressing root causes such as gut health. Our [best supplements for histamine intolerance](/blog/best-supplements-for-histamine-intolerance) roundup ranks the whole toolkit, and the complete [Histamine & MCAS protocol](/histamine-mcas) puts it in order. If your reactions are severe or systemic rather than food-linked, that points toward broader evaluation rather than DAO alone.',
      '## The bottom line',
      'DAO supplements can genuinely help with food-triggered histamine reactions, but they are not interchangeable \u2014 compare enzyme activity units rather than milligrams, favor well-studied sources and clean formulas, and take it about 15 minutes before higher-histamine meals. Used correctly alongside a lower-histamine diet and adequate B6, it is a precise and useful tool; used carelessly, it is easy to dismiss unfairly.',
    ],
    faqs: [
      {
        q: 'What should I look for in a DAO enzyme supplement?',
        a: 'Focus on the enzyme activity units (often listed as HDU) rather than milligrams, since milligram weight does not tell you how much active enzyme you get. Favor well-studied sources like porcine-derived DAO, choose a reputable brand with third-party quality control, and avoid fillers you might react to. Added cofactors like B6 can be convenient but watch your total intake.',
      },
      {
        q: 'When should I take DAO enzyme?',
        a: 'Take DAO shortly before eating \u2014 typically about 15 minutes before a higher-histamine meal \u2014 so the enzyme is present when the food arrives. Taking it after eating or away from food largely wastes it. It is meant for meals you know are higher in histamine, such as aged, fermented, or leftover foods, rather than necessarily every meal.',
      },
      {
        q: 'Why isn\u2019t my DAO supplement working?',
        a: 'The most common reasons are timing and product quality: taking it after meals instead of 15 minutes before, or using a product with low actual enzyme activity despite a high milligram number. DAO also only breaks down food histamine in the gut \u2014 it does not lower histamine your body produces internally \u2014 so if your reactions are not food-linked, DAO may not be the right tool.',
      },
      {
        q: 'Do I still need a low-histamine diet if I take DAO?',
        a: 'Yes \u2014 DAO works best alongside a lower-histamine diet, not as a replacement for it. The enzyme helps break down histamine in individual meals, but reducing your overall histamine load through diet means your system has far less to deal with. Combining both, plus supporting your own DAO with adequate B6 and copper, gives the best results.',
      },
    ],
  },
];
